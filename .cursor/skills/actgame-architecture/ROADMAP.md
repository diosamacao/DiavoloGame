...
| 模块 | 优先级 | 说明 |
|------|--------|------|
| 三人换人 / 极限支援 | P1 | 🟡 P-SW1/P-SW2 代码完成，Graph/Play 待验。P-SW2：金光切入 Guard 举刀，敌人 Hitbox 接触后 Success；被弹刀走 `IssueParried` → 现有 `HitState`。方案：[`docs/2026.8.30/PARTY_SWITCH_ASSIST_PLAN.md`](../../docs/2026.8.30/PARTY_SWITCH_ASSIST_PLAN.md) |
