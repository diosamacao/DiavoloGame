...
| 模块 | 优先级 | 说明 |
|------|--------|------|
| 三人换人 / 极限支援 | P1 | 🟡 P-SW1/P-SW2 代码完成，Graph/Play 待验。弹刀卡肉 HS0～HS3 已接线：接触后双方 `RequestHitStop`，Success 续冻。方案：[`docs/2026.8.30/PARTY_SWITCH_ASSIST_PLAN.md`](../../docs/2026.8.30/PARTY_SWITCH_ASSIST_PLAN.md)、[`docs/2026.9.5/ASSIST_PARRY_HITSTOP_PLAN.md`](../../docs/2026.9.5/ASSIST_PARRY_HITSTOP_PLAN.md) |
