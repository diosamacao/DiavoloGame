...
| 全局 Input + Locomotion 收敛 | ✅ Phase B2 | `GameInputSettings`；Mode.`animationProfile`；必填 `CharacterLocomotionProfile` | 已删 Config.Input/DefaultLocomotion 与 CreateInstance 容错 |
