...
/// <summary>
/// 图级共享路由：用一条规则表达多个来源节点共用的 Cancel 去向。
...
public class ActionGraphSharedRoute
{
    ...
    [Tooltip("匹配来源 Action 上的 CancelWindow 条目 Id。")]
    [SerializeField] string cancelSlotId = string.Empty;
    [Tooltip("匹配已缓冲的玩法意图。")]
    ...
    /// <summary>匹配的 Cancel 槽 Id。</summary>
