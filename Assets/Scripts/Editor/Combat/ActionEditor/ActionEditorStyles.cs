...
public static class ActionEditorStyles
{
    ...
    public static Color ColorForTrack(ActionTimelineTrackKind kind) => kind switch
    {
        ...
        ActionTimelineTrackKind.AssistCue => new Color(1f, 0.75f, 0.15f, 0.9f),
        ActionTimelineTrackKind.AssistParryWindow => new Color(0.85f, 0.95f, 0.35f, 0.9f),
        ...
        ActionTimelineTrackKind.Camera => new Color(0.25f, 0.65f, 1f, 0.9f),
    ...
    public static string DisplayName(ActionTimelineTrackKind kind) => kind switch
    {
        ...
        ActionTimelineTrackKind.AssistCue => "AssistCue",
        ActionTimelineTrackKind.AssistParryWindow => "AssistParry",
        ActionTimelineTrackKind.MotionModifier => "MotionModifier",
        ActionTimelineTrackKind.MotionCommand => "MotionCommand",
        ActionTimelineTrackKind.Camera => "Camera",
        _ => kind.ToString(),
    };
}
