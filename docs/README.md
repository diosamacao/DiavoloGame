...
> 更新：2026-08-12 — PivotTurn 两段式朝向已落地；BT 待优化真源见 8.11 Backlog。  
...
| [2026.8.10/LOCOMOTION_DIRECTIONAL_ANIMSET_PLAN.md](./2026.8.10/LOCOMOTION_DIRECTIONAL_ANIMSET_PLAN.md) | Locomotion AnimSet / 倾身 L-DIR4 / 相机跟朝向 L-DIR5 |
| [2026.8.12/PIVOT_TURN_TWO_PHASE_FACING_PLAN.md](./2026.8.12/PIVOT_TURN_TWO_PHASE_FACING_PLAN.md) | **PivotTurn 两段式朝向**（AnimAuth bake → InputAuth FollowInput；P-PIV1/2 已落地） |
