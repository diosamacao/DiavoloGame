...
| [2026.8.13/TEAM_PVE_NARAKA_STYLE_STATE_SYNC_PLAN.md](./2026.8.13/TEAM_PVE_NARAKA_STYLE_STATE_SYNC_PLAN.md) | **组队 PVE 联网真源**：Host 权威状态同步、InputFrame 上行、权威 Hitbox、§13 服务器代码规范 |
