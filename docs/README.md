...
> 更新：2026-08-13 — 新增组队 PVE 永劫式状态同步方案；锁步 L5 输入广播不再作为产品联网真源。
...
| [2026.8.13/TEAM_PVE_NARAKA_STYLE_STATE_SYNC_PLAN.md](./2026.8.13/TEAM_PVE_NARAKA_STYLE_STATE_SYNC_PLAN.md) | **组队 PVE 联网真源**：Host 权威状态同步、InputFrame 上行、权威 Hitbox |
