# ACTGame 相机系统方案（历史设计细节）

> **现行排期真源已迁至** [../2026.8.26/CAMERA_SYSTEM_PLAN.md](../2026.8.26/CAMERA_SYSTEM_PLAN.md)（2026-08-26：Director 多机位 + UI 展示舱；吸收 DemoClient）。阶段勾选与开工顺序以新篇为准。本文保留 C0～C4 设计备忘。  
...
> **排期真源：** [../2026.8.26/CAMERA_SYSTEM_PLAN.md](../2026.8.26/CAMERA_SYSTEM_PLAN.md)  
...
> 修订：2026-08-26 — 本文降为历史细节；排期改挂 2026.8.26 篇。
