...
> 关联：[ACTION_SYSTEM_LOCKSTEP_REFACTOR_PLAN.md](../ACTION_SYSTEM_LOCKSTEP_REFACTOR_PLAN.md)、[CAMERA_SYSTEM_PLAN.md](../2026.8.26/CAMERA_SYSTEM_PLAN.md)  
>  
...
| `GameplayIntentProducer` | Special / Ultimate / PerfectDodgeAttack（缓冲内攻击键劫持） |
